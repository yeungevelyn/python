...
#
#
#         mark = input("Enter {} mark ({}-{}): ".format(assessment_name,mark_min,mark_max))
#         try:
#             mark_int = int(mark)
#         except:
#             raise ValueError("{} mark is invalid".format(assessment_name))
#         if mark_int > mark_max or mark_int < mark_min:
#             raise ValueError("{} mark must be between {} and {}".format(assessment_name, mark_min, mark_max))
#         return mark_int
#
# #}
